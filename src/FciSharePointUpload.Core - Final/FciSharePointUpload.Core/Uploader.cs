...
namespace FciSharePointUpload.Core
{
    ...
    public class Uploader
    {
        ...
        private static FieldInformation[] ReadProperties(string fileName)
        {
            ...
            FsrmLib.IFsrmCollection properties = fsrmMgr.EnumFileProperties(fileName);
            ...
            for (int propertyIndex = 0; propertyIndex != properties.Count; propertyIndex++)
            {
                ...
                try
                {
                    ...
                    propDef = fsrmMgr.GetPropertyDefinition(property.Name);
                }
                catch
                {
            ...
            string user, string password)
        {
            ...
            CopyResult[] results;
            uint ret = copyClient.CopyIntoItems(" ", dest, fields, data, out results);
